...
export default function AboutProduct() {
  const pillars = [
    ...
    },
    {
      ...
      text: 'Этот документ невозможно купить готовым. Он создаётся специально для одного человека, на основе его даты рождения и места рождения, и существует в единственном экземпляре.',
    },
  ]
