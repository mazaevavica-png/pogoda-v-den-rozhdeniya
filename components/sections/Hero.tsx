      ...
      <div className="relative flex-1 flex flex-col justify-center max-w-7xl mx-auto px-5 md:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Персональный сертификат о погоде в день вашего рождения — составлен по официальным
              метеорологическим архивам. Точные данные, художественный нарратив, акварельная иллюстрация.
              Единственный в своём роде документ эпохи.
            </p>
